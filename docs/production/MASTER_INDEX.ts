...
export const MASTER_INDEX = {
  ...
  documentationMap: [
    ...
    },
    {
      ...
      type: 'Code Implementation',
      file: 'scripts/maintenance/generate-sitemaps.mjs',
      status: '✅ Complete',
      generates: [
  ...
  criticalFiles: {
    ...
    codeLevel: [
      ...
      '✓ src/app/App.tsx - Dynamic metadata by view',
      '✓ scripts/maintenance/generate-sitemaps.mjs (270 lines) - Sitemap generation',
    ],
    publicLevel: [
