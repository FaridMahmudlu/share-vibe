...
| `docs/security/FRONTEND_SECURITY_README.md` | Azerbaycanca döküman |
| `src/security/tests.ts` | Test suite |
| `src/security/examples/SecureFormExample.tsx` | React component |
...
```typescript
import SecureFormExample from '@/security/examples/SecureFormExample';
<SecureFormExample />
```
