...
**Current State**: `config/firebase/firebase-applet-config.json` committed to repository  
...
**Location**: `src/accessConfig.ts`, `src/pages/admin/AdminPanel.tsx`
...
```
1. Attacker finds config/firebase/firebase-applet-config.json in GitHub
